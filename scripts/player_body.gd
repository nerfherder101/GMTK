...
preload("res://resources/bodyparts/sentry/sentry_torso.tres"), preload("res://resources/bodyparts/sentry/sentry_head.tres"), preload("res://resources/bodyparts/sentry/sentry_larm.tres"), preload("res://resources/bodyparts/sentry/sentry_rarm.tres"), preload("res://resources/bodyparts/sentry/sentry_legs.tres"),
